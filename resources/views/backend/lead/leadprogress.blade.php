...
@section('content')
<a href="{{ route('lead.index') }}"><button type="button" class="btn btn-primary convert mb-3"><i class="fa fa-arrow-left" aria-hidden="true">  Back</i></button></a>
<div class="d-flex bd-highlight mb-3">
  ...
  <input placeholder="Select date" type="date" id="example_date" class="form-control"> 
    ...
    <div class="p-2 bd-highlight"> <button type="button" class="btn btn-primary progress">IN PROGRESS <i class="fa fa-chevron-right"style="margin-top:5px; margin-left:5px;"></i></button></div>
</div>
            ...
            <div class="d-flex bd-highlight mb-3">
                <div class="align-self-center">
                    <img src="backend/images/avatar-1.jpg" id="imageDiv" class="img-fluid customImage" alt=""
                        style="border-radius:50%;height:50px; width:50px;border:3px solid #2C814E;;">
                </div>
