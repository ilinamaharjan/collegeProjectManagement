<div class="modal-content">
    <div class="modal-header">
      <h5 class="modal-title">Contact Person Setup : </h5>
    ...
    <div class="modal-body">
        <div class="p-3">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group" id="contact_email">
                            <label class="form-label">Email<sup class="text-danger">*</sup> <span class="text-danger" onclick="addOrganizationFields('contact[email][]','email','contact_email')"><i class="fa fa-plus" aria-hidden="true"></i></span></label>
                    ...
                    <div class="col-md-6">
                        <div class="form-group" id="contact_number">
                            <label class="form-label">Contact Number<sup class="text-danger">*</sup> <span class="text-danger" onclick="addOrganizationFields('contact[number][]','number','contact_number')"><i class="fa fa-plus" aria-hidden="true"></i></span></label>
                    ...
                    @if (count($contact_custom_fields) > 0)
                        @foreach ($contact_custom_fields as $ocf)
                        <div class="col-md-6">
                            <div class="form-group">
            ...
            <a href="{{ route('custom_field.index','Contacts') }}" class="text-primary">Do u want to add custom fields</a>

        </div>
    </div>
    <div class="modal-footer">
      <button type="button" onclick="submitContactForm()" class="btn btn-primary lead">Submit</button>
    </div>
</div>