...
<div class="d-flex bd-highlight mb-3">
    <div class="align-self-center"><h5 class="mb-3"><b>Tasks and Appointments</b></h5></div>
    ...
    <ul class="nav nav-tab" role="tablist" style="border-bottom:1px solid #eaeaea;">
        ...
        <li class="nav-item">
            <div class="nav-link active" data-toggle="tab" href="#tabs-2" role="tab">
                <div style="border-right:1px solid #eaeaea;">
                    <span class="contract-detail p-2">Touched Record</span></div>
            </div>
        </li>
        ...
        <li class="nav-item">
            <div class="nav-link" data-toggle="tab" href="#tabs-3" role="tab">
                <div style="border-right:1px solid #eaeaea;">
                    <span class="contract-detail p-2">UnTouched Record</span></div>
            </div>
        </li>
...
<div class="bg-section mt-3 mb-5">
  ...
  <tbody>
    <tr>
      ...
      <td>Mark</td>
      <td><span style="color:#4046DD!important;"><span class="badge badge-success"></span>High</span></td>
      <td>@mdo</td>
    ...
    <tr>
      ...
      <td>Mark</td>
      <td><span style="color:#4046DD!important;"><span class="badge badge-danger"></span>low</span></td>
      <td>@mdo</td>
...
<i class="fa fa-plus" aria-hidden="true" style="font-size:smaller;"></i> Add Tasks
</button>
  ...
  <div class="modal-dialog">
    <div class="modal-content p-3">
      <div class="modal-header">
        <h5 class="modal-title" id="staticBackdropLabel">Add Task and Appointments</h5>
