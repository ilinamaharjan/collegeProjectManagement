...
class StatusSettingModuleSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        $modules = [
            [
                ...
                'sub_modules' => [
                    [
                        'name' => 'Lead Status Setting',
                        'display_name' => 'Lead Setting',
                        'status' => true                        
                    ],
                    [
                        'name' => 'Customer Status Setting',
                        'display_name' => 'Customer Setting',
                        'status' => true                        
                    ],
                    [
                        'name' => 'File Setting',
                        'display_name' => 'File Setting',
                        'status' => true,
                    ]
                ]
            ],
